...
import static lk.zmessenger.consumerwatchconsummer.CommonUtilities.displayMessage;
...
public class GCMIntentService extends GCMBaseIntentService {
	...
	protected void onRegistered(Context context, String registrationId) {
		...
		ServerUtilities.register(context, "1234", "1233", registrationId);
	}
	...
	protected void onMessage(Context context, Intent intent) {
		...
		if (intent.getExtras().containsKey("news")) {
			...
			Log.d("news", news);
			message = news;
			System.out.println("getId" + newsOBj.getId());
		}
